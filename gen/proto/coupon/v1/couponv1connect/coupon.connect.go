...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/coxwave/gen/coupon/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	CouponServiceName = "proto.coupon.v1.CouponService"
)
...
const (
	...
	// RPC.
	CouponServiceIssueCouponProcedure = "/proto.coupon.v1.CouponService/IssueCoupon"
)

// CouponServiceClient is a client for the proto.coupon.v1.CouponService service.
...
// NewCouponServiceClient constructs a client for the proto.coupon.v1.CouponService service. By
...
// IssueCoupon calls proto.coupon.v1.CouponService.IssueCoupon.
...
// CouponServiceHandler is an implementation of the proto.coupon.v1.CouponService service.
...
func NewCouponServiceHandler(svc CouponServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.coupon.v1.CouponService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCouponServiceHandler) IssueCoupon(context.Context, *connect.Request[v1.IssueCouponRequest]) (*connect.Response[v1.IssueCouponResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.coupon.v1.CouponService.IssueCoupon is not implemented"))
}
